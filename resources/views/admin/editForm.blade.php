...
<section id="userProfile" class="container mt-5">
    <div class="container">
        <div class="row text-light">
            ...
            <form action="{{ url('/admin/edit/' . $data->id) }}" method="post" id="formInput" class="my-5" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" placeholder="Title Article" name="title_articles" value="{{ old('title_articles', $data->title_articles) }}" />
                ...
                <div class="mb-3">
                    ...
                    <input id="content_articles" type="hidden" name="content_articles" value="{{ old('content_articles', $data->content_articles) }}"">
